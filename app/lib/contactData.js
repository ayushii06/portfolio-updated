const GITHUB_LINK = process.env.NEXT_PUBLIC_GITHUB_URL;
const LEETCODE_LINK = process.env.NEXT_PUBLIC_LEETCODE_URL;
const LINKEDIN_LINK = process.env.NEXT_PUBLIC_LINKEDIN_URL;
